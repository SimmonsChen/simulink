...
#define S_FUNCTION_NAME sfun_sbuild_filter
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      filter_coef
...
extern void sfun_sbuild_filter_Outputs_wrapper(const real_T *u,
                          real_T *y ,
			      const real_T  *xD,
                          const real_T  *filter_coef, const int_T p_width0,
			     const int_T y_width, const int_T u_width);
extern void sfun_sbuild_filter_Update_wrapper(const real_T *u,
                          const real_T *y ,
                           real_T *xD, 
                          const real_T  *filter_coef, const int_T  p_width0,
			     const int_T y_width, const int_T u_width);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *filter_coef  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const int_T        y_width = ssGetOutputPortWidth(S,0);
    const int_T        u_width = ssGetInputPortWidth(S,0);

    sfun_sbuild_filter_Outputs_wrapper(u, y, xD, filter_coef, p_width0, y_width, u_width);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfun_sbuild_filter_Update_wrapper(u, y,  xD, filter_coef, p_width0, y_width, u_width);
}
