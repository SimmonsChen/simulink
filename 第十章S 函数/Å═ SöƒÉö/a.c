...
extern void a_Outputs_wrapper(const int16_T  *u0,
                          int16_T  *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    int16_T   *y0  = (const int16_T*) ssGetOutputPortRealSignal(S,0);

    a_Outputs_wrapper(u0, y0);
}
